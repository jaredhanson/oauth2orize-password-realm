...
describe('exchange.password', function() {
  ...
  describe('issuing an access token based on scope', function() {
    function issue(client, username, passwd, realm, scope, done) {
      if (client.id !== 'c123') { return done(new Error('incorrect client argument')); }
      if (username !== 'bob') { return done(new Error('incorrect username argument')); }
      if (passwd !== 'shh') { return done(new Error('incorrect passwd argument')); }
      if (realm !== 'users') { return done(new Error('incorrect realm argument')); }
    ...
    before(function(done) {
      chai.connect.use(password(issue))
        .req(function(req) {
          req.user = { id: 'c123', name: 'Example' };
          req.body = { username: 'bob', password: 'shh', realm: 'users', scope: 'read' };
        })
        .end(function(res) {
          response = res;
          done();
  ...
  describe('issuing an access token based on array of scopes', function() {
    ...
    before(function(done) {
      chai.connect.use(password(issue))
        .req(function(req) {
          req.user = { id: 'c123', name: 'Example' };
          req.body = { username: 'bob', password: 'shh', realm: 'users', scope: 'read write' };
        })
        .end(function(res) {
          response = res;
          done();
  ...
  describe('issuing an access token based on scope and body', function() {
    function issue(client, username, passwd, realm, scope, body, done) {
      if (client.id !== 'c123') { return done(new Error('incorrect client argument')); }
      if (username !== 'bob') { return done(new Error('incorrect username argument')); }
      if (passwd !== 'shh') { return done(new Error('incorrect passwd argument')); }
      if (realm !== 'users') { return done(new Error('incorrect realm argument')); }
    ...
    before(function(done) {
      chai.connect.use(password(issue))
        .req(function(req) {
          req.user = { id: 'c123', name: 'Example' };
          req.body = { username: 'bob', password: 'shh', realm: 'users', scope: 'read', audience: 'https://www.example.com/' };
        })
        .end(function(res) {
          response = res;
          done();
  ...
  describe('issuing an access token based on authInfo', function() {
    function issue(client, username, passwd, realm, scope, body, authInfo, done) {
      if (client.id !== 'c123') { return done(new Error('incorrect client argument')); }
      if (username !== 'bob') { return done(new Error('incorrect username argument')); }
      if (passwd !== 'shh') { return done(new Error('incorrect passwd argument')); }
      if (realm !== 'users') { return done(new Error('incorrect realm argument')); }
  ...
  describe('handling a request without username parameter', function() {
    ...
    before(function(done) {
      ...
      chai.connect.use(password(issue))
        .req(function(req) {
          req.user = { id: 'c123', name: 'Example' };
          req.body = { password: 'shh', realm: 'users' };
        })
        .next(function(e) {
          err = e;
          done();
  ...
  describe('handling a request without password parameter', function() {
    ...
    before(function(done) {
      ...
      chai.connect.use(password(issue))
        .req(function(req) {
          req.user = { id: 'c123', name: 'Example' };
          req.body = { username: 'bob', realm: 'users' };
        })
        .next(function(e) {
          err = e;
          done();
  ...
  describe('handling a request without realm parameter', function() {
    var response, err;
    ...
    it('should error', function() {
      expect(err).to.be.an.instanceOf(Error);
      expect(err.constructor.name).to.equal('TokenError');
      expect(err.message).to.equal('Missing required parameter: realm');
      expect(err.code).to.equal('invalid_request');
      expect(err.status).to.equal(400);
    });
  });
